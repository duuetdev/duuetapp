...
import 'others_clinical_profile_model.dart';
export 'others_clinical_profile_model.dart';

class OthersClinicalProfileWidget extends StatefulWidget {
  const OthersClinicalProfileWidget({
    super.key,
  ...
  @override
  State<OthersClinicalProfileWidget> createState() =>
      _OthersClinicalProfileWidgetState();
}

class _OthersClinicalProfileWidgetState
    extends State<OthersClinicalProfileWidget> {
  late OthersClinicalProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OthersClinicalProfileModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'othersClinicalProfile'});
          ...
          desktop: false,
            ...
            ? AppBar(
                ...
                leading: FlutterFlowIconButton(
                  ...
                  onPressed: () async {
                    logFirebaseEvent(
                        'OTHERS_CLINICAL_PROFILE_arrow_back_round');
                    logFirebaseEvent('IconButton_navigate_back');
                    context.safePop();
                  },
                ),
                title: Text(
                  '${widget!.userRef?.userName}\'s Clinical Profile',
